...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    <div class="bg-white p-8 rounded-xl shadow-lg w-96">
        ...
        <form id="registerForm" method="post">
            ...
            <div class="mb-6">
                <label class="block text-xs text-gray-500 mb-2">Kode Admin (Opsional)</label>
                <input type="text" name="secret_key" class="w-full border p-2 rounded text-xs" placeholder="Kosongkan jika user biasa">
            </div>
            <button type="submit" class="w-full bg-orange-600 text-white font-bold py-2 rounded hover:bg-orange-700">Daftar</button>
        </form>
        <div class="mt-4 text-center text-sm">
            Sudah punya akun?
            <a href="login.php" class="text-orange-600 font-bold">Login</a>
        </div>
    </div>
